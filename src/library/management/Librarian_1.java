 ...
 */
@Entity
@Table(name = "librarian", catalog = "library_managment", schema = "")
@NamedQueries({
...
public class Librarian_1 implements Serializable {
    ...
    public Librarian_1(Integer id, String name, String password, String email, String address, String city, int contact) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "library.management.Librarian_1[ id=" + id + " ]";
    }
